    ...
    <body class='bg-light'>
        <div class='container d-flex justify-content-center align-items-center vh-100'>
            <div class='alert alert-danger text-center shadow'>
                <ion-icon name='lock-closed-outline' style='font-size:40px; color:#dc3545;'></ion-icon>
                <h4 class='alert-heading mb-3'>Acceso denegado</h4>
...
<head>
    <meta charset="UTF-8">
    <title>Notificaciones de Administrador</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
    <style>
...
<body>
    <div class="notificaciones-container">
        ...
        if (mysqli_num_rows($resultado) > 0) {
            // Mostrar cada notificación como "carta"
            while ($notificacion = mysqli_fetch_assoc($resultado)) {
                ...
                if ($notificacion['id_empresa']) {
                    echo "<a href='gestionar_empresas.php?id_empresa={$notificacion['id_empresa']}' class='btn btn-outline-primary btn-sm btn-gestion'>
                        <ion-icon name='business-outline'></ion-icon> Gestionar Empresa
                    </a>";
                }
                echo "</div>";
            }
